  ...
  <body>
   ...
   <?php include_once("includes/footer.php");?>
    ...
    <div class="floatingLnk">
        <div class="inn">
            <ul>
                <li><a href="#section1" class="page-scroll"><img src="images/features-icons/stay-icon.png" alt="pura"></a></li>
                <li><a href="#section2" class="page-scroll"><img src="images/features-icons/cafe-tab-icon.png" alt="pura"></a></li>
                <li><a href="#section3" class="page-scroll"><img src="images/features-icons/exp-icon.png" alt="pura"></a></li>
                <li><a href="#section4" class="page-scroll"><img src="images/features-icons/operation-icon.png" alt="pura"></a></li>
            </ul>
        </div>   
    </div>
        <style>
