...
if(isset($_REQUEST["logout"]))
  {
    ...
    printf("<script>location.href='http://purastays.com'</script>");  
    exit();
  }
		            ...
		            $.ajax({
				        ...
				        success: function(res){
				        	...
				        	if(res.status==1){
				                ...
				                var lnk2 = "http://purastays.com/includes/social-login.php?fid=&gid="+res.gid;		                
				                $.ajax({
								  method: "GET",
								  url: lnk2,
								  error: function() {
		...
		FB.api('/me', function(response) {
	    	...
	    	$.ajax({
		        ...
		        success: function(res){
		        	if(res.status==1){
						otherData = {"userid": res.userid, "name": res.name, "mobile": res.mobile, "email": res.email, "fid": res.fid, "gid": res.gid}		               		                
		                var lnk2 = "http://purastays.com/includes/social-login.php?fid="+res.fid+"&gid=";		                
		                $.ajax({
						  method: "GET",
						  url: lnk2,
						  error: function() {
          ...
          <div class="modal-body">
             <form method="post" id="signupForm">   
                ...
                <div class="row">    
                    <div class="col-sm-12">    
	                    <fieldset class="form-group">  
	                    	<div class="pull-left terms-txt">By signing up you agree to our <a href="terms-conditions.php">Terms & Conditions</a></div>                      	
