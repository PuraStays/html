...
//define('PAYTM_MERCHANT_KEY', 'G&ogMGjo_hsbQL54'); 
//define('PAYTM_MERCHANT_MID', 'Gradia71463106552734'); 
//define('PAYTM_MERCHANT_WEBSITE', 'Gradiatorweb');

//prod servver
define('PAYTM_ENVIRONMENT', 'PROD'); 
//define('PAYTM_MERCHANT_KEY', 'U4xHF!gpdaGWlhho'); //stagining
define('PAYTM_MERCHANT_KEY', 'FuQslBGIs_CsMznV'); 
//define('PAYTM_MERCHANT_MID', 'PuraHo98686709779356'); //stagining
define('PAYTM_MERCHANT_MID', 'Hoilda09598722408370');
define('PAYTM_MERCHANT_WEBSITE', 'Puraweb');
