...
<?php  
  ...
  {
     $qry_offer = "select * from promotions  where Show_Index = '1' && Status = 1 && Active_From <= '$Date' && Active_To >= '$Date'";
  }
  else
  { 
  ...
  <div class="modal-dialog modal-lg offerPopup">
    ...
    <div class="modal-content">
      <div class="popup_container">
  		  <div class="popup_image_container" style="background: url(<?= $row_offer['Background'];?>) no-repeat center bottom"></div>
