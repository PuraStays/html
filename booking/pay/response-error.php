...
?>
					...
					if($isValidChecksum == "TRUE") {						
							...
							if($db->_query($qry))
							{
								...
								if($confirm->response->status->code==1602)
									...
									//mail send starts here
							            ...
							            $mail->Subject = "Test mail : Any Questions?";
							            ...
							            {
							              $data['status'] = '1';
							              $data['message'] = 'Your query has been successfully sent.';
							            }
							            else
							            {
							              $data['status'] = '0';
                    	...
                    	?>
							<div class="alert alert-success" style="width:80%; margin:100px auto; max-width:500px;">
								...
								<?php echo "<b>Your Transaction ID: </b>" . $_REQUEST["ORDERID"] . " <br/>"; ?>
								...
								<input type="submit" value="Submit_vdoit" name="submit" class="btn btn-success">
								-->
								
						    	<a class="btn btn-success" href="http://www.purastays.com">Home</a>
        ...
        else
        {
            ...
            echo '<br /><br />';
            echo '<a class="btn btn-success" href="http://www.purastays.com">Home</a>';
        }
    ?>
            </div>
        </div>
