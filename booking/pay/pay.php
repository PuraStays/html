	...
	<script src="js/jquery-1.11.3.min.js"></script>
		<script type="text/javascript">
			...
			var goToHome = function() {
				window.location.href='http://www.purastays.com/';
			}
			var statusJson = {
				"MID":"<?php echo $paramList["MID"] ?>",
				"ORDERID":"<?php echo $paramList["ORDER_ID"] ?>"
			}
			var stausUrl = 'https://secure.paytm.in/oltp/HANDLER_INTERNAL/TXNSTATUS?jsonData=' + JSON.stringify(statusJson);
			//console.log(stausUrl);
			document.f1.submit();
			$.ajax({
				url: stausUrl,
			...
			//		console.log(response);
					if(response.STATUS == "OPEN") {
						...
						$('center').hide();
						$('body').append('h3').html("Something went wrong! Please contact <strong>+91 90 1551 1551</strong> <br> go to <a href='http://www.purastays.com/'>Home</a>").css({'text-align':'center', 'font-size': '18px', 'color': '#2D3B3F'});
