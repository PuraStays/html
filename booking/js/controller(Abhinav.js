...
app.controller('SummaryCtrl', function($scope,$rootScope, $log, $state, $http, sideBarSrvc, $uibModal, bookingDataSrvc, stateCheckSrvc){
  ...
  var startBooking = function(){
	...
	//Abhinav session for get all data
	$http({
		//url:"purastays.com/booking/pay/response.php";
        url: "./pay/mail_test.php",
        method: "POST",
        data: {
            data: $scope.allData
        }
    }).success(function(response) {
    console.log('Mail Data send successfully');
	console.log($scope.allData);
});
   
//end of function vdoit
