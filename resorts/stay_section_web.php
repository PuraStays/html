                ...
                <div class="sec-inner">
                    <div class="trans-div">
                        <div class="list-container" id="stay-container">
                            ...
                            <?php
                                $qry_img = "select Image, Alt from images";
                                $result_img = $db->_query($qry_img);
                                while($rows_img = $result_img->fetch_assoc())
                                    {
                                        $img_alt_arr[$rows_img['Image']] = $rows_img['Alt'];
                                    }
                                                ...
                                                <div class="list-item" data-id="<?=$rows['Id']; ?>">
                                                    <div class="list-item-content">
                                                        <figure>
                                                            ...
                                                            ?>
                                                            <img src="<?= $room_images[0]; ?>" alt="<?= $img_alt_arr[$room_images[0]]; ?>">
                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ($feature_id as $key => $value) {
                                                                        if($activities_arr[$value]!="")
                                                                            echo '<li><img src="'.$activities_arr[$value].'" alt="'.$img_alt_arr[$activities_arr[$value]].'"></li>';
                                                                }      
                                                            ?>
                                                        </ul>
