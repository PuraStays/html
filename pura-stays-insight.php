                    ...
                    <div class="trans-div half-blk-txt no-trans">
                        <div class="actual-txt">
                            <?php
                                ...
                                if($db->is_mobile())
                                    {
                                        $arr1 = explode("<p>", $row['Stay_Description']);
                                        echo '<p>'.$arr1[1];
                                    }
                                else
                                    {
                                        echo $row['Stay_Description'];
                                    }
                             ?>
                        </div>    
                    </div>
                    ...
                    <div class="trans-div half-blk-txt no-trans">
                        <div class="actual-txt">
                            <?php
                                ...
                                if($db->is_mobile())
                                    {
                                        $arr1 = explode("<p>", $row['Cafe_Description']);
                                        echo '<p>'.$arr1[1];
                                    }
                                else
                                    {
                                        echo $row['Cafe_Description'];
                                    }
                             ?>
                        </div>    
                    </div>
                    ...
                    <div class="trans-div half-blk-txt no-trans">
                        <div class="actual-txt">
                            <?php
                                ...
                                if($db->is_mobile())
                                    {
                                        $arr1 = explode("<p>", $row['Experiences_Description']);
                                        echo '<p>'.$arr1[1];
                                    }
                                else
                                    {
                                        echo $row['Experiences_Description'];
                                    }
                             ?>
                    ...
                    <div class="trans-div half-blk-txt no-trans">
                        <div class="actual-txt">
                            ...
                            <?php
                                ...
                                if($db->is_mobile())
                                    {
                                        $arr1 = explode("<p>", $row['Operations_Description']);
                                        echo '<p>'.$arr1[1];
                                    }
                                else
                                    {
                                        echo $row['Operations_Description'];
                                    }
                             ?>
